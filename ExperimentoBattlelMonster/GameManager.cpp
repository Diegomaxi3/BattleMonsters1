...
Creature* GameManager::selector(int npcRandom) {
	...
	case 1: {
		...
		return criature = new Creature("Dracore", 500, 60, 6, dracoreMovemntens, new SpriteDracore());
		break;
	}
	case 2: {
		...
		return criature = new Creature("Mythosaurio", 390, 40, 7, mythosaurioMovemntens, new SpriteMythosaur());
		break;
	}
	case 3: {
		...
		return criature = new Creature("Erebin", 250, 60, 4, ereblinMovements, new SpriteEreblin());
		break;
	}
	case 5: {
		...
		return criature = new Creature("CannonApe", 200, 78, 5, cannonapeMovements, new SpriteCannonBall());
		break;
	}
	case 4: {
		...
		return criature = new Creature("Agrios", 450, 50, 3, agriosMovements, new SpriteAgrios());
		break;
	}
	case 6: {
		...
		return criature = new Creature("Morsax", 400, 30, 2, morsaxMovements, new SpriteMorsax());
		break;
	}
	}
